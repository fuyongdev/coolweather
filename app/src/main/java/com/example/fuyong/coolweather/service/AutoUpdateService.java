package com.example.fuyong.coolweather.service;
...
public class AutoUpdateService extends Service {
    ...
    private void updateWeather() {
        SharedPreferences prifs = PreferenceManager.getDefaultSharedPreferences(this);
        String weatherStr = prifs.getString("weather", null);
        if (weatherStr != null) {
